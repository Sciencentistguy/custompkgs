...
[
  ...
  {
    goPackagePath = "github.com/dchest/uniuri";
    fetch = {
      type = "git";
      url = "https://github.com/dchest/uniuri";
      rev = "8902c56451e9";
      sha256 = "1x5bsbm1nlphsv96zd0rbclfaa1swpz5bp14x7s5dbxp0awk2gd4";
      moduleDir = "";
    };
  }
  {
  ...
  {
    goPackagePath = "github.com/zpeters/speedtest";
    fetch = {
      type = "git";
      url = "https://github.com/zpeters/speedtest";
      rev = "v1.0.3";
      sha256 = "09myfqqxji3gwzy5vvhkwi52ag5dz9ynd2zw7f1zpapzjsgiqzyi";
      moduleDir = "";
    };
  }
  {
